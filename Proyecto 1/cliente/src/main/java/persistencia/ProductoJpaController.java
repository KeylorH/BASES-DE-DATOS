...
public class ProductoJpaController implements Serializable {
    ...
    public List<Producto> findProductosPorCategoria(int idCategoria) {
        EntityManager em = getEntityManager();
        try {
            Categoria categoria = em.find(Categoria.class, idCategoria);
            TypedQuery<Producto> query = em.createQuery("SELECT p FROM Producto p WHERE p.categoria = :categoria", Producto.class);
